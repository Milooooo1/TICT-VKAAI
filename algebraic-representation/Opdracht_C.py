...
Zie beargumentatie B waarom ik ook nu voor de spoiler heb gekozen. Ook daar heb ik 
uitgelegd waarom deze configuratie slim is. Het enige verschil bij deze configuratie
is de manier waarop de outputs worden geclassificeerd. In dit geval zorgt de laatste 
convolutie layer ervoor dat er n aantal filters worden gemaakt van de verschillende 
mogelijke outputs die allemaal 1 pixel groot en breed zijn door de kernel van 5x5 
...
conv2d (Conv2D)                 (None, 24, 24, 20)       520
    Aangezien padding niet "same" is en de layer een kernel size heeft van 5x5 
    zijn er 2 pixels van alle kanten af wat zorgt voor een shape van 24x24 pixels 
    voor 20 filters lang
...
max_pooling2d (MaxPooling2D)    (None, 12, 12, 20)       0 
    ...
    hij doet echter niks met het aantal filters dat blijft gelijk

    Aantal params blijft gelijk

conv2d_1 (Conv2D)               (None, 10, 10, 20)       3620 
    padding != "same" kernel size van 3x3 haalt 1 pixel van alle kanten af dus vandaar
    van 12x12 naar 10x10, de conv2d layer heeft 20 filters dus vandaar 10,10,20
...
conv2d_2 (Conv2D)               (None, 1, 1, 10)          5010
    Omdat de kernel size 5x5 is en de padding valid kan je maar een keer de kernel
    over de afbeelding heen gooien wat voor een output van 1 pixel zorgt, dit doet hij 
    voor 10 verschillende filters vandaar de outputshape 1, 1, 10
...
optimizer = keras.optimizers.Adam(learning_rate=learningrate) #lr=0.01 is king
